          ...
          results.pages.length > 0 ? (
            results.pages.map(page => (
              <div 
                ...
                className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex items-center justify-between cursor-pointer hover:bg-gray-50 hover:shadow-md transition"
              >
                <div className="flex items-center gap-4">
                  {/* Initials wala Icon */}
                  <div className="w-12 h-12 bg-purple-100 text-purple-700 rounded-lg flex items-center justify-center font-bold text-xl">
